...
namespace HelloWeb.Data
{
    public class MachineContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=192.168.56.101;Database=BegEFCore;Trusted_Connection=false;User=sa;Password=Jurras1c");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SupportLog>(entity =>
            {
                ...
                entity.Property(e => e.SupportLogEntry)
                    .IsRequired()
                    .IsUnicode(false);
                entity.Property(e => e.SupportLogEntryDate).HasColumnName("date");
